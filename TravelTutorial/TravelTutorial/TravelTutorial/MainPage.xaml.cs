...
namespace TravelTutorial
{
	public partial class MainPage : ContentPage
	{
		public MainPage()
		{
            ...
            //assigns a variable of type 'MainPage' not type Mainpage
            var assembly = typeof(MainPage);
            //assigns the image source property to the path of the image
            //embeds the image file into the project, and the assembly of type 'Mainpage'
            imgIcon.Source = ImageSource.FromResource
                ("TravelTutorial.Assetts.Images.leaf_acenta.png", assembly);
