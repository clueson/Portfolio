...
{
    public class ViewRightLBViewModel : BindableBase
    {
        #region Fields
        ...
        IChangeViewColours IViewColours { get; set; }
        ...
        private void SetNewBackgroundColour(string thetag)
        {
            ...
            //Assigns an dictionary object with values from the interface
            Dictionary<string, SolidColorBrush> Listboxstyles = IViewColours.ColourDictionaryChangeEntry(thetag);
